...
angular.module('lumi',['ngRoute','ngResource'])
  .config(['$routeProvider', function($routeProvider) {
    $routeProvider
      ...
      .when('/Estoques',{templateUrl:'views/Estoque/search.html',controller:'SearchEstoqueController'})
      .when('/Estoques/new',{templateUrl:'views/Estoque/detail.html',controller:'NewEstoqueController'})
      .when('/Estoques/edit/:EstoqueId',{templateUrl:'views/Estoque/detail.html',controller:'EditEstoqueController'})
