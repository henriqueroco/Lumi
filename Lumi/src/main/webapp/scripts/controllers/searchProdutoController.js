...
angular.module('lumi').controller(
		'SearchProdutoController',
		function($scope, $http, $filter, ProdutoResource) {
			...
			$scope.tipoEmbalagemList = [ "AMPOLA", "BISNAGA", "CAIXA", "POTE",
					"UNIDADE" ];

			$scope.unidadeMedidaEmbalagemList = [ "KG", "G", "MG", "UND", "L",
					"ML" ];

			$scope.formaUtilizacaoList = [ "FIXO", "SUGERIDO" ];

			$scope.unidadeMedidaUtilizacaoList = [ "KG", "G", "MG", "UND", "L",
					"ML" ];
