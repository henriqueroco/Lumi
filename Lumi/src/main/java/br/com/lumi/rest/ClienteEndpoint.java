...
public class ClienteEndpoint
{
   ...
   {
      TypedQuery<Cliente> findByIdQuery = em.createQuery("SELECT DISTINCT c FROM Cliente c LEFT JOIN FETCH c.logradouro WHERE c.id = :entityId ORDER BY c.id", Cliente.class);
   ...
   {
      TypedQuery<Cliente> findAllQuery = em.createQuery("SELECT DISTINCT c FROM Cliente c LEFT JOIN FETCH c.logradouro ORDER BY c.id", Cliente.class);
