...
public class ClienteEndpoint {
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Cliente> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Cliente c LEFT JOIN FETCH c.logradouro WHERE c.id = :entityId ORDER BY c.id",
						Cliente.class);
	...
	public List<Cliente> listAll(@QueryParam("start") Integer startPosition,
		...
		TypedQuery<Cliente> findAllQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Cliente c LEFT JOIN FETCH c.logradouro ORDER BY c.id",
						Cliente.class);
